...
AS86		=as
CC86	=cc 
LD86	=ld -Ttext 0x0 --oformat binary

AS	=as --32
LD	=ld 
LDFLAGS	= -m elf_i386 -e startup_32 -Ttext 0x0 --oformat binary -fno-PIE -shared 
CC	=gcc
CFLAGS	=-m32 -Wall -O -fstrength-reduce -fomit-frame-pointer -fno-PIC 
